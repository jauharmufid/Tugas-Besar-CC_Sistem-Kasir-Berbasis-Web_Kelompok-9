<?php
    ...
    if(isset($_POST['proses'])){
        ...
        if($user == 'admin' && $pass == 'admin'){
            ...
            $_SESSION['user'] = $user;
            $_SESSION['status'] = "login";
            echo '<script>alert("Login Sukses");window.location="index_kasir.php"</script>';
        }else{
...
<img src="assets/img/Logo kasir web.png" alt="Logo" class="logo">
