  ...
  <div class="row">
    ...
    <div class="col-md-3 mb-2 d-none d-md-block">
        <div class="card">
            ...
            <div class="card-tittle text-white">Halo, <b><?php echo $_SESSION['user']; 
            ?>
            </b>
          </div>
            </div>
            <div class="card-body">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="barang.php"><i class="fa fa-shopping-bag text-purple mr-2"></i> Update Barang</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="laporan.php"><i class="fa fa-table text-purple mr-2"></i>Laporan Penjualan</a>
                    </li>
                    <li class="nav-item">
