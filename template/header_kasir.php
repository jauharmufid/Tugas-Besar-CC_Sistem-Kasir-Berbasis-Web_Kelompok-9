...
<nav class="navbar navbar-expand-lg navbar-dark bg-purple text-white shadow-sm sticky-top d-md-none d-lg-none d-xl-none">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link putih" href="index_kasir.php"><i class="fa fa-desktop mr-2"></i>Kasir</a>
                    </li>
                    <li class="nav-item">
  ...
  <div class="row">
    ...
    <div class="col-md-3 mb-2 d-none d-md-block">
        <div class="card">
            ...
            <div class="card-tittle text-white">Halo, <b><?php echo $_SESSION['user']; ?></b></div>
            </div>
            <div class="card-body">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="index_kasir.php"><i class="fa fa-desktop text-purple mr-2"></i>Kasir</a>
                    </li>
                    <li class="nav-item">
